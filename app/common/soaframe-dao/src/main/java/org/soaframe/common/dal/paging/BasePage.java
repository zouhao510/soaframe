...
public class BasePage<T> {
    ...
    private List<T> datas;                  //对象记录结果�?
    private int     total           = 0;    // 总记录数
    private int     limit           = 20;   // 默认每页显示记录�?
    private int     pageNos         = 1;    // 总页�?
    private int     currPageNo      = 1;    // 当前�?

    private boolean isFirstPage     = false; //是否为第�?�?
    private boolean isLastPage      = false; //是否为最后一�?
    private boolean hasPreviousPage = false; //是否有前�?�?
    private boolean hasNextPage     = false; //是否有下�?�?

    private int     navigatePages   = 8;    //导航页码�?
    private int[]   navigatePageNos;        //�?有导航页�?
