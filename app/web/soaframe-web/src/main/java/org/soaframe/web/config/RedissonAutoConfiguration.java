...
import org.soaframe.core.service.impl.RedisDistribuiteLocker;
import org.soaframe.core.service.impl.RedissLockUtil;
...
public class RedissonAutoConfiguration {
	 ...
	 */
	@Bean
	RedisDistribuiteLocker distributedLocker(RedissonClient redissonClient) {
		RedisDistribuiteLocker locker = new RedisDistribuiteLocker();
